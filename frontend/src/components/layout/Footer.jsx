...
//       <div className="grid grid-cols-1 md:grid-cols-4 gap-6 px-4 md:px-[120px] py-12 max-w-[1200px] mx-auto text-right">
...
//             © {new Date().getFullYear()} عيادة Lumina Dental. جميع الحقوق محفوظة.
//           </p>
//         </div>

//         {/* TODO: نربطها بـ useClinicInfo لاحقاً بدل هذي القيم الثابتة */}
...
//               >
//                 الهاتف: 000 00 00 213+
//               </a>
//             </li>
//             <li className="font-body text-on-surface-variant">العنوان: لاغوات، الجزائر</li>
//           </ul>
//         </div>
...
//           <ul className="flex flex-col gap-3">
//             <li className="font-body text-on-surface-variant">الأحد - الخميس: 9:00 ص - 8:00 م</li>
//             <li>
//               <Link
//                 to="/contact"
//                 className="font-body text-on-surface-variant hover:text-primary transition-colors flex items-center gap-2"
//               >
//                 عرض الخريطة <Icon name="map" className="text-[18px]" />
//               </Link>
//             </li>
//           </ul>
//         </div>
